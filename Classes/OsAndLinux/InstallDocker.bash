...
# Prendre ladresse IP de la machine
...
apt-get install -y apt-transport-https ca-certificates curl gnupg lsb-release grep software-properties-common snap
...
# Terminer linstallation de Docker Engine
apt-get update
...
echo "Veuillez faire les ajustement nécessaire sur pgadmin $ip4 :8081 avant de continuer"
